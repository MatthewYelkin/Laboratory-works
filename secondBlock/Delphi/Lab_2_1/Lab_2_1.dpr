...
Begin
    ...
    For I := 0 to LastNum Do  //Ввод координат вершин
    Begin
    ...
    Begin
        ...
        If I = LastNum Then  //Вычисление последнего вектора
        Begin
            Vector[N - 1][0] := Coordinates[0][0] - Coordinates[N - 1][0];
		       	Vector[N - 1][1] := Coordinates[0][1] - Coordinates[N - 1][1];
        End
        Else   //Вычисление первого и до предпоследнего векторов
        Begin
