...
{$I+}
        ...
        Begin
            IsCorrect := False;
            Writeln('Ошибка ввода. Количество неизвестных системы уравнений целое число большее 1. ');
        End;
    Until IsCorrect;
...
Begin
    If ConsolOrFileInput
      ('Вы хотите сохранить результат программы в файл?(0 - Да/ 1 - Нет).') = 0 then
    Begin
...
begin
    If ConsolOrFileInput
      ('Нажмите 0, если хотите работать в консоли, 1 , если в файле.') = 0 then
